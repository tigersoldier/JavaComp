...
import org.javacomp.parser.classfile.AttributeInfo;
import org.javacomp.parser.classfile.ClassFileInfo;
import org.javacomp.parser.classfile.ClassFileParser;
import org.javacomp.parser.classfile.ClassInfoConverter;
import org.javacomp.parser.classfile.ConstantPoolInfo;
import org.javacomp.parser.classfile.FieldInfo;
import org.javacomp.parser.classfile.MethodInfo;
import org.javacomp.parser.classfile.ParsedClassFile;
...
public class JarPrinter {
  ...
  public void parseAndPrint(String jarFilename, Optional<String> classFilename) {
    ...
    String jarUri = "jar:file:" + Paths.get(jarFilename).toAbsolutePath().normalize().toString();
    FileSystem fs;
    try {
      fs = FileSystems.newFileSystem(URI.create(jarUri), ImmutableMap.of());
    } catch (IOException e) {
  ...
  private static void printHelp() {
    ...
    System.out.println("  Prints the interal representation of parsed .class files.");
    System.out.println();
    System.out.println(
