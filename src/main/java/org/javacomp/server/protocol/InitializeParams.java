...
public class InitializeParams implements RequestParams {
  ...
  public static class InitializationOptions implements JavaCompOptions {
    ...
    /**
     * A list of file paths that contains additional type indeces generated by the Indexer tool.
     *
     * <p>The path can be either relative to the project root path, or an absolute path.
     */
    @Nullable public List<String> typeIndexFiles;
    ...
    public List<String> getTypeIndexFiles() {
      if (typeIndexFiles == null) {
        return ImmutableList.of();
      }
      return ImmutableList.copyOf(typeIndexFiles);
    }
  }
